...
const LandingPage = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const res = await axios.get(process.env.REACT_APP_URI + 'statistics');
    ...
    <div className='landing-page-container'>
        ...
        <ul>
          <li>
            <h1>
              <span>Mazon</span>{' '}
              <span>
                <IoPowerSharp className='power-icon' />
                nline
              </span>
            </h1>
          </li>
          ...
          <li>
            ...
            <button onClick={() => history.push('/i/signup')}>Sign up</button>
          </li>
        </ul>
      </nav>
      ...
      <div className='landing-page-wraper' id='content'>
        ...
        <div className='landing-page-content' data-aos='fade-right'>
          <div>
            ...
            <p>
              We are a supermarket online service that deliver your orders to
              your home!
            </p>
            ...
            <p>
              We carefully selected and cooperated with a variety of
              supermarkets, which are located in city centers across the
              country, in order to be as close as possible to our customers, and
              provide to our customers the freshest and fastest delivery, while
              maintaining the highest level of service and quality.
            </p>
          </div>
      ...
      <footer>
        ...
        <div className='copyright-box'>
          <p>
            Developed by{' '}
            <a href='https://github.com/itamarrosenblum' target='_blank'>
              Itamar Rosenblum
            </a>
          </p>
        </div>
