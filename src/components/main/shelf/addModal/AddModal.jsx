    ...
    >
      <div className='modal-wraper'>
        <div className='modal-content'>
          <figure>
            <Image cloudName='itamarrosenblum' publicId={selectedProduct.img} />
          ...
          <div className='btn-box'>
            {objProductCart.find((x) => x.id === selectedProduct.id) ? (
              <div className='quantity-box'>
                <button
                  onClick={() =>
                    incrementProductCart(selectedProduct.id, 'reduce')
                  }
                >
                  <span>
                    <IoRemoveOutline />
                ...
                <div>
                  {objProductCart.map((k) => {
                    return (
                      <span key={k.id}>
                        {k.id === selectedProduct.id
                          ? k.productCart.quantity
                          : null}
                      </span>
                    );
                  })}
                ...
                <button
                  onClick={() =>
                    incrementProductCart(selectedProduct.id, 'increment')
                  }
                >
                  <span>
                    <IoAddOutline />
