...
const ForgotPsw = () => {
  ...
  const resetPass = async (email) => {
    ...
    try {
      ...
      await axios.put(process.env.REACT_APP_URI + 'session', { email: email });
    ...
    return (
      <div className='forgot-psw-container'>
        <div className='email-sent-box'>
          ...
          <h2>Thank you</h2>
          <p>
            If your account is associated with this email address you will
            receive an email to reset your password.
          </p>
          <button onClick={() => history.push('/i/login')} className='btn-link'>
            Back to Log in
          </button>
        </div>
      </div>
